...
public class ParcialArboles5 {
    ...
    public static void main(String[] args) {
        ...
        GeneralTree<Integer> nodo42 = new GeneralTree<Integer>(42);
        GeneralTree<Integer> nodoMinus5 = new GeneralTree<Integer>(-5);
        GeneralTree<Integer> nodo5 = new GeneralTree<Integer>(5);
        GeneralTree<Integer> nodo22 = new GeneralTree<Integer>(22);
        GeneralTree<Integer> nodo19 = new GeneralTree<Integer>(19);
        GeneralTree<Integer> nodoMinus9 = new GeneralTree<Integer>(-9);
        GeneralTree<Integer> nodo6 = new GeneralTree<Integer>(6);
        GeneralTree<Integer> nodo28 = new GeneralTree<Integer>(28);
        GeneralTree<Integer> nodo55 = new GeneralTree<Integer>(55);
